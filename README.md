...
本项目为课程结课作业。论文和数据收集由本人独立完成，代码由prompt+Cursor完成。情感列的标注分别试用了模型Claude 3.7 Sonnet、ChatGPT-4o、Gemini 2.5 flash、omnidimen-4b-emotion、Claude 4.5 Sonnet，最终是手动校准过的结果。其余标注由手工完成。
